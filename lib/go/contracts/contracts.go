...
func Lilium(fungibleTokenAddr string) []byte {
	code := assets.MustAssetString(liliumFilename)
...
// CustomToken returns the Lilium contract with a custom name.
//
// The returned contract will import the FungibleToken interface from the specified address.
